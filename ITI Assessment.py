...
.welcome::after{content:'🎓';position:absolute;right:32px;top:50%;transform:translateY(-50%);font-size:80px;opacity:0.15}
...
<body>
<div class="topbar">
  <div class="logo"><span>🎓</span> ITI Assessment System</div>
  <div class="user-info">
